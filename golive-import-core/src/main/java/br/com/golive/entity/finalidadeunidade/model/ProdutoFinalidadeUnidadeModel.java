...
@Entity
@Table(name = "tbFinalidadeUnidadeProduto")
@Label(name = "label.cadastroFinalidadeUnidade")
@Jasper(titulo = "label.cadastroFinalidadeUnidade.finalidadeUnidadeProduto", nomeDoArquivoGerado = "file.name.finalidadeunidade", nomeArquivoJasper = "FinalidadeUnidade")
public class ProdutoFinalidadeUnidadeModel extends Model {
	...
	@Column(name = "FinalidadeUnidadeProduto")
	...
	public ProdutoFinalidadeUnidadeModel(Long numeroMinimoCaracteres,
			Long numeroMaximoCaracteres, String finalidadeUnidadeProduto,
			boolean apresentacaoSistemaLookupPesquisas,
			boolean apresentacaoSistemaGridPesquisas,
			boolean apresentacaoSistemaRelatoriosCadastrais,
			boolean apresentacaoSistemaGraficosCadastrais,
	...
	public ProdutoFinalidadeUnidadeModel() {
		super();
	}

	public ProdutoFinalidadeUnidadeModel(Long id, Calendar dataInclusao,
