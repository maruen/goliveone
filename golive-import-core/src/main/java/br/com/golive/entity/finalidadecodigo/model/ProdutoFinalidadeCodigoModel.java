package br.com.golive.entity.finalidadecodigo.model;
...
@Entity
@Table(name = "tbFinalidadeCodigoProduto")
@Label(name = "label.cadastroFinalidadeCodigo")
@Jasper(titulo = "label.cadastroFinalidadeCodigo.finalidadeCodigoProduto", nomeDoArquivoGerado = "file.name.finalidadecodigo", nomeArquivoJasper = "FinalidadeCodigo")
public class ProdutoFinalidadeCodigoModel extends Model {
	...
	@Column(name = "FinalidadeCodigoProduto")
	private String finalidadeCodigoProduto;
	...
	public String getFinalidadeCodigoProduto() {
		return finalidadeCodigoProduto;
	}

	public void setFinalidadeCodigoProduto(String finalidadeCodigoProduto) {
		this.finalidadeCodigoProduto = finalidadeCodigoProduto;
	}
	...
	public ProdutoFinalidadeCodigoModel(Long numeroMinimoCaracteres,
			Long numeroMaximoCaracteres, String finalidadeCodigoProduto,
			boolean apresentacaoSistemaLookupPesquisas,
			boolean apresentacaoSistemaGridPesquisas,
			boolean apresentacaoSistemaRelatoriosCadastrais,
			boolean apresentacaoSistemaGraficosCadastrais,
	...
	public ProdutoFinalidadeCodigoModel() {
		super();
	}

	public ProdutoFinalidadeCodigoModel(Long id, Calendar dataInclusao,
