...
@Entity
@Table(name = "tbFinalidadeColecaoProduto")
@Label(name = "label.cadastroFinalidadeColecao")
@Jasper(titulo = "label.cadastroFinalidadeColecao.finalidadeColecaoProduto", nomeDoArquivoGerado = "file.name.finalidadecolecao", nomeArquivoJasper = "FinalidadeColecao")
public class ProdutoFinalidadeColecaoModel extends Model{
	...
	@Column(name = "FinalidadeColecaoProduto")
	...
	public ProdutoFinalidadeColecaoModel(Long numeroMinimoCaracteres,
			Long numeroMaximoCaracteres, String finalidadeColecaoProduto,
			boolean apresentacaoSistemaLookupPesquisas,
			boolean apresentacaoSistemaGridPesquisas,
			boolean apresentacaoSistemaRelatoriosCadastrais,
			boolean apresentacaoSistemaGraficosCadastrais,
	...
	public ProdutoFinalidadeColecaoModel() {
		super();
	}

	public ProdutoFinalidadeColecaoModel(Long id, Calendar dataInclusao,
