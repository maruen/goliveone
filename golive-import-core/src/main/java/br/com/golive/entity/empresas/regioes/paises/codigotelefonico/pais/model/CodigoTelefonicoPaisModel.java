package br.com.golive.entity.empresas.regioes.paises.codigotelefonico.pais.model;
...
public class CodigoTelefonicoPaisModel extends Model {
	...
	public CodigoTelefonicoPaisModel(){
		this.dataInclusao = Calendar.getInstance();
		this.dataAlteracao = Calendar.getInstance();
	}
	
	public CodigoTelefonicoPaisModel(Long id,
