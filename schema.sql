...
-- -----------------------------------------------------
-- Table `golive`.`tbUsuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `golive`.`tbUsuario` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `golive`.`tbUsuario` (
  `Id` INT UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
...
SHOW WARNINGS;
CREATE UNIQUE INDEX `Id_UNIQUE` ON `golive`.`tbUsuario` (`Id` ASC);

SHOW WARNINGS;
CREATE UNIQUE INDEX `Login_UNIQUE` ON `golive`.`tbUsuario` (`Login` ASC);
