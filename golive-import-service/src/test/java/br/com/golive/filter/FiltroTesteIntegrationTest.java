...
public class FiltroTesteIntegrationTest {
	...
	// filtrarSetInicio(parametroRetorno, numberFilter, widget,
	// TipoFiltro.IGUAL);
	//
	...
	// filtrarSetInicio(parametroRetorno, dateFilter, widget,
	// TipoFiltro.PERIODO);
	// }
	//
	// // </Date>
	...
	// filtrarSetInicio(parametroRetorno, stringFilter, widget,
	// TipoFiltro.CONTEM);
	//
	// }
	//
	...
	// filtrarSetInicio(parametroRetorno, stringFilter, "nome",
	// TipoFiltro.CONTEM);
	...
	// filtrarSetInicio(parametroRetorno, numberFilter, "id",
	// TipoFiltro.INTERVALO);
	//
	// }
	//
	...
	// }
	//
	// private <T> void limparFiltro(final GoliveFilter<T> filter, final String
	// campo, final int esperado) {
	// limparFiltrosELista(filter);
	// filtrarSetInicio(new HashMap<Object, Object>(), filter, campo,
	// filter.getTipo());
	// Assert.assertEquals(bean.getFiltrada().size(), esperado);
	//
	// }
	//
	// public <T> void filtrarSetInicio(final Map<Object, Object>
	// parametroRetorno, final GoliveFilter<T> filter, final String campo, final
	// TipoFiltro tipo) {
	// filter.setTipo(tipo);
	// if (parametroRetorno.keySet().isEmpty()) {
	// bean.getFilter().filtrar(bean.getLista(), bean.getFiltrada(), filter,
	// campo);
	// }
	...
	// bean.getFilter().filtrar(bean.getLista(), bean.getFiltrada(), filter,
	// campo);
	// Assert.assertEquals(bean.getFiltrada().size(),
	// parametroRetorno.get(key));
	// }
	//
	...
	// bean.getFilter().filtrar(bean.getLista(), bean.getFiltrada(),
	// bean.getFiltroData(), "data");
