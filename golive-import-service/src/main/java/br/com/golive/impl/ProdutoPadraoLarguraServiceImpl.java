...
public class ProdutoPadraoLarguraServiceImpl implements ProdutoPadraoLarguraService {
	...
	public void salvar(ProdutoPadraoLarguraModel model) {
		...
		produtoPadraoLarguraJPA.refresh(model.getDepartamentoSelected());
		produtoPadraoLarguraJPA.refresh(model.getGrupoProdutoSelected());
		produtoPadraoLarguraJPA.refresh(model.getSubGrupoProdutoSelected());
		produtoPadraoLarguraJPA.refresh(model.getColecaoSelected());
		produtoPadraoLarguraJPA.refresh(model.getCorProdutoSelected());
