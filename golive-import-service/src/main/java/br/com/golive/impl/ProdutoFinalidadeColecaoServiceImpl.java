...
import br.com.golive.entity.finalidadecolecao.repositorio.ProdutoFinalidadeColecaoJPA;
...
public class ProdutoFinalidadeColecaoServiceImpl implements
		ProdutoFinalidadeColecaoService {

	@Inject
	private Logger logger;

	@Inject
	private ProdutoFinalidadeColecaoJPA produtoFinalidadeColecaoJPA;

	@Override
	public List<ProdutoFinalidadeColecaoModel> obterLista(Usuario usuario,
			Empresa empresa) {
		logger.info("Obtendo lista de FinalidadeColecao = {} ");
		return produtoFinalidadeColecaoJPA.obterLista();
	}

	@SuppressWarnings("rawtypes")
	@Override
	public LazyModel<ProdutoFinalidadeColecaoModel> obterListaLazy(
		...
		return produtoFinalidadeColecaoJPA.obterListaLazy(startIndex, pageSize, parameters, order, subQueries, listLazy);
	}
	...
	public void salvar(Usuario usuario, Empresa empresa,
			ProdutoFinalidadeColecaoModel entity) {
		logger.info("Salvando FinalidadeColecao ={}", entity);
		produtoFinalidadeColecaoJPA.save(entity);
	}
	...
	public void atualizar(Usuario usuario, Empresa empresa,
			ProdutoFinalidadeColecaoModel entity) {
		logger.info("Atualizando FinalidadeColecao ={}", entity);
		produtoFinalidadeColecaoJPA.update(entity);
	}
	...
	public void remover(Usuario usuario, Empresa empresa,
			ProdutoFinalidadeColecaoModel entity) {
		logger.info("Removendo FinalidadeColecao ={}", entity);
		produtoFinalidadeColecaoJPA.delete(entity);
	}
	...
	public void refresh(Usuario usuario, Empresa empresa,
			ProdutoFinalidadeColecaoModel entity) {
		produtoFinalidadeColecaoJPA.refresh(entity);
	}
}