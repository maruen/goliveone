...
public class ServiceUtils {
	...
	// public static List<ColunaPerfil> criarConfiguracaoPaginaUsuario(final
	// List<ColunaPerfil> tableColunas, final Class<?>... entityClasses) {
	...
	// throw new GoLiveException("Classe = " + entityClass.getName() +
	// ", coluna = " + coluna);
	// }
	//
	// }
	...
	// private static ColunaPerfil getColuna(final String coluna, final
	// List<ColunaPerfil> colunasTabela, final Long cont) throws GoLiveException
	// {
	// for (final ColunaPerfil colunaPerfil : colunasTabela) {
	// if (colunaPerfil.getColuna().equals(coluna)) {
