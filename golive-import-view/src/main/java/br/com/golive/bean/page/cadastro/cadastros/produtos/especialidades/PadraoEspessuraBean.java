...
import br.com.golive.entity.padraoespessura.model.PadraoEspessuraModel;
...
@ManagedBean
@ViewScoped
public class PadraoEspessuraBean extends CadastroBeanRules<PadraoEspessuraModel> {
	...
	public List<PadraoEspessuraModel> criarList() {
		final List<PadraoEspessuraModel> lista = new ArrayList<PadraoEspessuraModel>();
		
		for (Integer i = 0; i < 10; i++) {
			lista.add(new PadraoEspessuraModel(new Long(i), Calendar.getInstance(), Calendar.getInstance(), 
