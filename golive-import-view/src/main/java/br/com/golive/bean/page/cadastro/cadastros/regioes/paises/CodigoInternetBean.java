...
import br.com.golive.entity.empresas.regioes.paises.codigointernet.model.CodigoInternetModel;
...
public class CodigoInternetBean extends CadastroBeanRules<CodigoInternetModel> {
	...
	private List<CodigoInternetModel> criarLista() {
		...
		for (Integer i = 0; i < 10; i++){
			lista.add(new CodigoInternetModel(new Long(i), Calendar.getInstance(), Calendar.getInstance(), ".af", "Afeganistão", "Afghnistan", "ښبثلشدهسفګشخ"));
		}
		return lista;
	}
