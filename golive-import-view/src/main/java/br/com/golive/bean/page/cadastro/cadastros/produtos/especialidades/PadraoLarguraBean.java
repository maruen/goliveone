...
import br.com.golive.entity.padraolargura.model.PadraoLarguraModel;
...
@ManagedBean
@ViewScoped
public class PadraoLarguraBean extends CadastroBeanRules<PadraoLarguraModel>{
	...
	private List<PadraoLarguraModel> criarLista() {
		final List<PadraoLarguraModel> lista = new ArrayList<PadraoLarguraModel>();
		
		for (Integer i = 0; i < 10; i++){
			lista.add(new PadraoLarguraModel(new Long(i), Calendar.getInstance(), Calendar.getInstance(), "2.58", 
