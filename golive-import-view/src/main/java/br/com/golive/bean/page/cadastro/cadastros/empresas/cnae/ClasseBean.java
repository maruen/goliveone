...
public class ClasseBean extends CadastroBeanRules<ClasseModel> {
	...
	private List<ClasseModel> criarLista() {
		...
		for (Integer i = 0; i < 10; i ++){
			lista.add(new ClasseModel(new Long(i), new Date(), new Date(), "A", 
					"Agricultura, Pecuária, Produção Florestal, Pesca e Aquicultura", 
					"000000001", "01", "Agricultura, Pecuária e Serviços Relacionados", 
					"000000001", "01.1", "Produção de lavouras temporárias", "000000001", 
