...
import br.com.golive.entity.empresas.fornecedor.model.FornecedorModel;
...
@ManagedBean
@ViewScoped
public class FornecedorBean extends CadastroBeanRules<FornecedorModel> {
	...
	private List<FornecedorModel> criarLista() {
		final List<FornecedorModel> lista = new ArrayList<FornecedorModel>();
		
		for (Integer i = 0; i < 10; i++){
			lista.add(new FornecedorModel(new Long(i), Calendar.getInstance(), Calendar.getInstance(), "09.363.143/0001-00", "111.222.333-11", "Alpex Alumínio", "Ind.Com.de Alumínios Alpex Ltda."));
		}
